...
使用以下命令进行注释，这里的dbNSFP4.3a使用了ALL来注释所有内容，实际上可以仅指定需要的。
```
vep \
	--offline \
	...
	--plugin SpliceAI,snv=/ykrt/data/backup/databases/vep_data/Plu_data/spliceai_scores.raw.snv.hg19.vcf.gz,indel=/ykrt/data/backup/databases/vep_data/Plu_data/spliceai_scores.raw.indel.hg19.vcf.gz,cutoff=0.5 \
	--fasta /path/to/reference.fa --assembly GRCh37
```
